...
const RAW_QUESTION_BANK = [
  ...
  // RAZONAMIENTO VERBAL
  // ==========================================
  { id: 'v_go_1', category: 'Verbal', source: 'Guía Oficial', type: 'Antónimo', question: 'Selecciona el antónimo de: ADECUADO', options: ['Analizado', 'Estupendo', 'Inadvertido', 'Incorrecto', 'Inesperado'], correctAnswer: 3, explanation: 'Lo opuesto a adecuado es incorrecto.' },
  { id: 'v_go_2', category: 'Verbal', source: 'Guía Oficial', type: 'Antónimo', question: 'Selecciona el antónimo de: AUTÉNTICA', options: ['Falsa', 'Dependiente', 'Devaluada', 'Descompuesta', 'Flexible'], correctAnswer: 0, explanation: 'Lo opuesto a auténtico (verdadero) es falso.' },
  { id: 'v_go_3', category: 'Verbal', source: 'Guía Oficial', type: 'Antónimo', question: 'Selecciona el antónimo de: DIVERSIDAD', options: ['Uniformidad', 'Opulencia', 'Llaneza', 'Oposición', 'Aburrimiento'], correctAnswer: 0, explanation: 'Diversidad implica variedad; uniformidad implica igualdad.' },
  { id: 'v_go_4', category: 'Verbal', source: 'Guía Oficial', type: 'Antónimo', question: 'Selecciona el antónimo de: NOTORIO', options: ['Escabroso', 'Detallado', 'Caprichoso', 'Ilusorio', 'Inadvertido'], correctAnswer: 4, explanation: 'Notorio es conocido; inadvertido pasa desapercibido.' },
  { id: 'v_go_5', category: 'Verbal', source: 'Guía Oficial', type: 'Antónimo', question: 'Selecciona el antónimo de: REACIO', options: ['Confuso', 'Fácil', 'Dócil', 'Rancio', 'Inútil'], correctAnswer: 2, explanation: 'Reacio se resiste; dócil obedece.' },
  { id: 'v_go_6', category: 'Verbal', source: 'Guía Oficial', type: 'Antónimo', question: 'Selecciona el antónimo de: INDÓMITO', options: ['Discreto', 'Gobernable', 'Devastador', 'Débil', 'Atónito'], correctAnswer: 1, explanation: 'Indómito es salvaje; gobernable se controla.' },
  { id: 'v_go_7', category: 'Verbal', source: 'Guía Oficial', type: 'Completar', question: 'Completa la oración: Los animales pueden _______ de muchas formas los problemas _______ por los cambios estacionales.', options: ['soportar - comunitarios', 'afrontar - causados', 'rechazar - proporcionados', 'esquivar - esperados', 'someter - propiciados'], correctAnswer: 1, explanation: 'Afrontar problemas causados es la relación lógica.' },
  { id: 'v_go_8', category: 'Verbal', source: 'Guía Oficial', type: 'Completar', question: 'Completa la oración: La mundialización del ideal democrático no suprime las relaciones de _______ entre las naciones.', options: ['masas', 'fuerza', 'comprensión', 'pobreza', 'impulso'], correctAnswer: 1, explanation: 'Contexto de realpolitik: persisten las relaciones de fuerza.' },
  { id: 'v_inv_1', category: 'Verbal', source: 'Investigación', type: 'Analogía', question: 'Completa la analogía: VOCACIÓN : OFICIO ::', options: ['necesidad : satisfactor', 'sacrificio : triunfo', 'capacidad : tarea', 'producción : producto', 'calidad : meta'], correctAnswer: 2, explanation: 'Requisito intrínseco para la actividad.' },
  { id: 'v_inv_2', category: 'Verbal', source: 'Investigación', type: 'Analogía', question: 'Completa la analogía: PINTOR : BROCHA ::', options: ['escultor : cincel', 'médico : medicina', 'abogado : leyes', 'mecánico : coche', 'profesor : alumno'], correctAnswer: 0, explanation: 'Sujeto : Instrumento.' },
  { id: 'v_inv_3', category: 'Verbal', source: 'Investigación', type: 'Antónimo', question: 'Selecciona el antónimo de: EFÍMERO', options: ['Duradero', 'Fugaz', 'Rápido', 'Mortal', 'Eterno'], correctAnswer: 0, explanation: 'Efímero (corto) vs Duradero (largo).' },
  { id: 'v_inv_4', category: 'Verbal', source: 'Investigación', type: 'Completar', question: 'Completa la oración: El _______ no es compatible con la _______; quien duda no puede actuar con convicción.', options: ['amor - esperanza', 'odio - paz', 'escepticismo - fe', 'dinero - avaricia', 'trabajo - pereza'], correctAnswer: 2, explanation: 'Escepticismo (duda) vs Fe (convicción).' },
  { id: 'v_inv_5', category: 'Verbal', source: 'Investigación', type: 'Analogía', question: 'Completa la analogía: CORAZÓN : SANGRE ::', options: ['cerebro : ideas', 'pulmón : aire', 'estómago : comida', 'bomba : agua', 'tanque : gasolina'], correctAnswer: 3, explanation: 'Órgano/Mecanismo que impulsa un fluido (Bomba:Agua).' },
  { id: 'v_inv_6', category: 'Verbal', source: 'Investigación', type: 'Antónimo', question: 'Selecciona el antónimo de: ALTRUISTA', options: ['Egoísta', 'Bondadoso', 'Rico', 'Pobre', 'Amable'], correctAnswer: 0, explanation: 'Altruista piensa en otros; egoísta en sí mismo.' },
  ...
  { id: 'm_go_2', category: 'Matemáticas', source: 'Guía Oficial', type: 'Geometría', question: 'Calcula la longitud de una rampa para subir una plataforma de 5m de altura, si empieza a 12m de la orilla:', options: ['13', '17', '25', '60', '119'], correctAnswer: 0, explanation: 'Pitágoras: √(5² + 12²) = 13.' },
  { id: 'm_go_3', category: 'Matemáticas', source: 'Guía Oficial', type: 'Álgebra', question: 'Calcula el resultado de: -2(1 - 3/4)²', options: ['-10/14', '-1/8', '1/8', '10/14', '17/16'], correctAnswer: 1, explanation: '-2 * (1/4)² = -2 * 1/16 = -1/8.' },
  { id: 'm_go_4', category: 'Matemáticas', source: 'Guía Oficial', type: 'Probabilidad', question: 'Calcula la probabilidad de obtener 7 lanzando un par de dados:', options: ['1/6', '3/8', '1/2', '4/6', '5/6'], correctAnswer: 0, explanation: '6 combinaciones favorables / 36 totales = 1/6.' },
  { id: 'm_go_5', category: 'Matemáticas', source: 'Guía Oficial', type: 'Cálculo', question: 'Si x = -4t³ + 20t² + 80t + 100, calcula la velocidad en t=3:', options: ['92', '94', '96', '98', '100'], correctAnswer: 0, explanation: 'v = dx/dt = -12t² + 40t + 80. Evaluar en t=3.' },
  ...
  { id: 'm_inv_3', category: 'Matemáticas', source: 'Investigación', type: 'Geometría', question: 'Calcula el área de un círculo con radio 4:', options: ['8π', '16π', '4π', '12π', '64π'], correctAnswer: 1, explanation: 'A = πr² = 16π.' },
  { id: 'm_inv_4', category: 'Matemáticas', source: 'Investigación', type: 'Probabilidad', question: 'Calcula la probabilidad de obtener sol en un volado (lanzamiento de moneda):', options: ['1/2', '1/3', '1/4', '1', '0'], correctAnswer: 0, explanation: '1 de 2 opciones.' },
  { id: 'm_inv_5', category: 'Matemáticas', source: 'Investigación', type: 'Álgebra', question: 'Factoriza la expresión: x² - 9', options: ['(x-3)(x-3)', '(x+3)(x+3)', '(x+3)(x-3)', '(x-9)(x+1)', '(x-1)(x+9)'], correctAnswer: 2, explanation: 'Diferencia de cuadrados.' },
  { id: 'm_inv_6', category: 'Matemáticas', source: 'Investigación', type: 'Aritmética', question: 'Calcula el MCD de 12 y 18:', options: ['2', '3', '6', '12', '36'], correctAnswer: 2, explanation: 'El mayor divisor común es 6.' },

  // ==========================================
  // HABILIDAD COGNITIVA
  // ==========================================
  { id: 'c_go_1', category: 'Cognitiva', source: 'Guía Oficial', type: 'Secuencias', question: 'Completa la secuencia: B1, C3, D5, E7, F9, ___', options: ['H17', 'H13', 'G15', 'G13', 'G11'], correctAnswer: 4, explanation: 'Letra +1, Número +2.' },
  { id: 'c_go_2', category: 'Cognitiva', source: 'Guía Oficial', type: 'Relaciones', question: 'Analiza las relaciones: Caballo:Mar :: Automóvil:Tierra :: Ballena:Barco. ¿Cuál es la relación implícita o error?', options: ['Superficie...', 'Tierra, submarino, avestruz', 'Camino, barco, águila', 'Avión, cielo, águila', 'Camino, submarino, avestruz'], correctAnswer: 4, explanation: 'Matriz lógica de medio/vehículo.' },
  { id: 'c_go_3', category: 'Cognitiva', source: 'Guía Oficial', type: 'Secuencias', question: 'Completa la secuencia numérica: 10, 13, 16, 19, ___', options: ['21', '22', '23', '24', '20'], correctAnswer: 1, explanation: 'Suma 3.' },
  { id: 'c_go_4', category: 'Cognitiva', source: 'Guía Oficial', type: 'Relaciones', question: '¿Qué significa la metáfora: "El ocaso de la vida"?', options: ['Adolescencia', 'Nacimiento', 'Vejez', 'Juventud', 'Madurez'], correctAnswer: 2, explanation: 'Metáfora de final/atardecer.' },
  { id: 'c_go_5', category: 'Cognitiva', source: 'Guía Oficial', type: 'Secuencias', question: 'Completa la secuencia: 7ZA14, 16WC32, ___', options: ['36QG68', '34QG68', '34GQ68', '36RG68', '38RG68'], correctAnswer: 1, explanation: 'Patrón complejo alfanumérico.' },
  { id: 'c_go_6', category: 'Cognitiva', source: 'Guía Oficial', type: 'Lógica', question: 'Determina el orden en la fila: Hernández tras González, González tras Ruiz.', options: ['González, Ruiz, Hernández', 'Ruiz, Hernández, González', 'Hernández, González, Ruiz', 'Ruiz, González, Hernández', 'González, Hernández, Ruiz'], correctAnswer: 3, explanation: 'Ruiz -> González -> Hernández.' },
  { id: 'c_inv_1', category: 'Cognitiva', source: 'Investigación', type: 'Secuencia', question: 'Completa la secuencia: 2, 4, 8, 16, ___', options: ['30', '32', '24', '18', '20'], correctAnswer: 1, explanation: 'Potencias de 2.' },
  { id: 'c_inv_2', category: 'Cognitiva', source: 'Investigación', type: 'Visual', question: 'Selecciona la figura que sigue: Triángulo, Cuadrado, Pentágono...', options: ['Hexágono', 'Heptágono', 'Octágono', 'Círculo', 'Rombo'], correctAnswer: 0, explanation: 'Lados: 3, 4, 5 -> 6.' },
  { id: 'c_inv_3', category: 'Cognitiva', source: 'Investigación', type: 'Silogismo', question: 'Deduce la conclusión: Todos los hombres son mortales. Sócrates es hombre.', options: ['Sócrates es inmortal', 'Sócrates es mortal', 'Sócrates es filósofo', 'Todos son Sócrates', 'Nada'], correctAnswer: 1, explanation: 'Deducción directa.' },
  { id: 'c_inv_4', category: 'Cognitiva', source: 'Investigación', type: 'Analogía', question: 'Completa la analogía: LIBRO : LEER ::', options: ['música : escuchar', 'cuadro : pintar', 'canción : componer', 'guitarra : tocar', 'película : actuar'], correctAnswer: 0, explanation: 'Objeto : Acción pasiva.' },
  { id: 'c_inv_5', category: 'Cognitiva', source: 'Investigación', type: 'Secuencia', question: 'Completa la secuencia: A, C, E, G, ___', options: ['H', 'I', 'J', 'K', 'L'], correctAnswer: 1, explanation: 'Salta una letra: B, D, F, H... Sigue I.' },
  ...
  // REDACCIÓN
  // ==========================================
  { id: 'r_go_1', category: 'Redacción', source: 'Guía Oficial', type: 'Incoherencia', question: 'Identifica la oración incorrecta (con ambigüedad):', options: ['Vi a mi amigo bajando del avión.', 'Al bajar yo del avión vi a mi amigo.', 'Vi a mi amigo cuando él bajaba.', 'Todas correctas', 'Ninguna correcta'], correctAnswer: 0, explanation: 'Anfibología (ambigüedad).' },
  { id: 'r_go_2', category: 'Redacción', source: 'Guía Oficial', type: 'Concordancia', question: 'Selecciona la oración con la concordancia correcta:', options: ['Asistieron veintiún personas', 'Asistieron veintiuna personas', 'Asistió veintiún personas', 'Asistieron veinte y un personas', 'Habían veintiún personas'], correctAnswer: 1, explanation: 'Concordancia de género (femenino).' },
  { id: 'r_go_3', category: 'Redacción', source: 'Guía Oficial', type: 'Pleonasmo', question: 'Identifica el error de pleonasmo:', options: ['La base fundamental', 'La base esencial', 'El fundamento básico', 'Todas tienen pleonasmo', 'Ninguna'], correctAnswer: 3, explanation: 'Redundancia en todos los casos.' },
  { id: 'r_go_4', category: 'Redacción', source: 'Guía Oficial', type: 'Gramática', question: 'Selecciona el uso correcto de "médica":', options: ['La médico', 'La médica', 'El médica', 'La doctor', 'El doctor mujer'], correctAnswer: 1, explanation: 'Profesión en femenino.' },
  { id: 'r_go_5', category: 'Redacción', source: 'Guía Oficial', type: 'Régimen', question: 'Selecciona la expresión correcta:', options: ['Coincidieron de que', 'Coincidieron en que', 'Coincidieron que', 'Coincidieron a que', 'Coincidieron con que'], correctAnswer: 1, explanation: 'Coincidir "en".' },
  { id: 'r_inv_1', category: 'Redacción', source: 'Investigación', type: 'Ortografía', question: 'Identifica la palabra escrita correctamente:', options: ['Desición', 'Decisión', 'Decición', 'Desisión', 'Dezición'], correctAnswer: 1, explanation: 'C y S.' },
  { id: 'r_inv_2', category: 'Redacción', source: 'Investigación', type: 'Acentuación', question: 'Identifica la palabra aguda:', options: ['Árbol', 'Mesa', 'Canción', 'Teléfono', 'Libro'], correctAnswer: 2, explanation: 'Fuerza en la última sílaba.' },
  { id: 'r_inv_3', category: 'Redacción', source: 'Investigación', type: 'Puntuación', question: 'Identifica el ejemplo correcto del uso de coma vocativa:', options: ['Hola Juan', 'Hola, Juan', 'Hola Juan,', 'Hola; Juan', 'Hola. Juan'], correctAnswer: 1, explanation: 'Vocativo separado por coma.' },
  { id: 'r_inv_4', category: 'Redacción', source: 'Investigación', type: 'Barbarismo', question: 'Selecciona la forma correcta:', options: ['Haiga', 'Haya', 'Allá', 'Halla', 'Aya'], correctAnswer: 1, explanation: 'Del verbo haber.' },
  { id: 'r_inv_5', category: 'Redacción', source: 'Investigación', type: 'Queísmo', question: 'Selecciona la oración correcta:', options: ['Me di cuenta de que', 'Me di cuenta que', 'Me enteré que', 'Dudo que vengas', 'Pienso de que'], correctAnswer: 0, explanation: 'Requiere preposición "de".' },
  { id: 'r_inv_6', category: 'Redacción', source: 'Investigación', type: 'Sintaxis', question: 'Selecciona la oración con el orden lógico:', options: ['El niño comió la manzana roja', 'La roja manzana comió el niño', 'Comió roja la manzana el niño', 'El niño la roja manzana comió', 'Roja la manzana el niño comió'], correctAnswer: 0, explanation: 'Sujeto + Verbo + Predicado (orden natural).' },
  { id: 'r_inv_7', category: 'Redacción', source: 'Investigación', type: 'Homófonos', question: 'Completa correctamente: "No _______ bien el agua".', options: ['Hierba', 'Hierva', 'Yerba', 'Yerva', 'Ierba'], correctAnswer: 1, explanation: 'Hierva (del verbo hervir).' },

  // ==========================================
  // INGLÉS (Parte VII)
  // ==========================================
  { id: 'e_go_1', category: 'Inglés', source: 'Guía Oficial', type: 'Grammar', question: 'Complete the sentence: I _______ already _______ lesson five.', options: ['have... studied', 'has... studying', 'am... studied', 'hasnt... studied', 'are... studying'], correctAnswer: 0, explanation: 'Present Perfect.' },
  { id: 'e_go_2', category: 'Inglés', source: 'Guía Oficial', type: 'Comparatives', question: 'Complete the sentence: The movie was much _______ than I expected.', options: ['go', 'best', 'better', 'more good', 'gooder'], correctAnswer: 2, explanation: 'Comparativo irregular.' },
  { id: 'e_go_3', category: 'Inglés', source: 'Guía Oficial', type: 'Modals', question: 'Complete the sentence: You _______ be in your classroom!', options: ['may', 'can', 'must', 'might', 'would'], correctAnswer: 2, explanation: 'Obligación.' },
  { id: 'e_go_4', category: 'Inglés', source: 'Guía Oficial', type: 'Prepositions', question: 'Complete the sentence: There\'s somebody _______ the window.', options: ['at', 'on', 'in', 'down', 'under'], correctAnswer: 0, explanation: 'Ubicación específica.' },
  { id: 'e_go_5', category: 'Inglés', source: 'Guía Oficial', type: 'Pronouns', question: 'Complete the sentence: The driver took _______ home.', options: ['we', 'he and I', 'they', 'our', 'us'], correctAnswer: 4, explanation: 'Object Pronoun.' },
  { id: 'e_inv_1', category: 'Inglés', source: 'Investigación', type: 'Conditionals', question: 'Complete the sentence: If I _______ rich, I would travel.', options: ['am', 'was', 'were', 'have been', 'would be'], correctAnswer: 2, explanation: 'Second Conditional (were).' },
  { id: 'e_inv_2', category: 'Inglés', source: 'Investigación', type: 'Tenses', question: 'Complete the sentence: She _______ working here for ten years.', options: ['is', 'has been', 'have been', 'was', 'are'], correctAnswer: 1, explanation: 'Present Perfect Continuous.' },
  { id: 'e_inv_3', category: 'Inglés', source: 'Investigación', type: 'Vocabulary', question: 'Select the opposite of "expensive":', options: ['hard', 'easy', 'cheap', 'soft', 'wealthy'], correctAnswer: 2, explanation: 'Cheap (barato).' },
  { id: 'e_inv_4', category: 'Inglés', source: 'Investigación', type: 'Phrasal Verbs', question: 'Complete the phrasal verb: _______ the lights when you leave.', options: ['turn on', 'turn off', 'turn in', 'turn up', 'turn out'], correctAnswer: 1, explanation: 'Apagar (turn off).' },
  { id: 'e_inv_5', category: 'Inglés', source: 'Investigación', type: 'Quantifiers', question: 'Complete the sentence: I don\'t have _______ money.', options: ['some', 'many', 'much', 'a few', 'no'], correctAnswer: 2, explanation: 'Much (incontable negativo).' },
  { id: 'e_inv_6', category: 'Inglés', source: 'Investigación', type: 'Prepositions', question: 'Complete the phrase: Good _______ math.', options: ['in', 'at', 'on', 'for', 'to'], correctAnswer: 1, explanation: 'Good at (bueno para/en).' },
  { id: 'e_inv_7', category: 'Inglés', source: 'Investigación', type: 'Gerunds', question: 'Complete the sentence: I enjoy _______ books.', options: ['read', 'to read', 'reading', 'reads', 'readed'], correctAnswer: 2, explanation: 'Enjoy + gerundio.' },
];
          ...
          <div className="p-8 border-b border-slate-100/50 bg-gradient-to-br from-slate-50/80 to-white/60">
            <div className="flex justify-between items-start mb-4">
              <div className="flex flex-wrap gap-2">
                ...
                <span className="px-3 py-1.5 rounded-lg text-[11px] font-black uppercase tracking-wider shadow-sm bg-slate-100 text-slate-600 border border-slate-200">
                  {question.type}
                </span>
              </div>
